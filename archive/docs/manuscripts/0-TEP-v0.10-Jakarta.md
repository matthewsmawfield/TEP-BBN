...
*Supersession Note: Earlier formulations of TEP utilized phenomenological epoch-screening functions to artificially preserve a standard hot-plasma expansion history. The framework has since evolved to uniquely derive thermodynamic closure from the canonical action in an eternal universe. The "hot Big Bang" is formally rejected in the canonical architecture.*
...
The classical stellar astration paradox is resolved natively. While stellar processing is infinite, local chemical evolution is driven into a steady-state asymptotic attractor. The unbounded accumulation of heavy elements is prevented by local temporal sequestration: the formation of local Temporal Horizons (black holes) imposes infinite transport delays that permanently remove heavy metals from the active baryonic cycle. Consequently, the observed light-element abundances are not primordial artifacts of a global singularity, but the inescapable thermodynamic resting state of an eternal universe.

The Cosmic Microwave Background is similarly reinterpreted as the steady-state thermalized equilibrium of distributed intergalactic starlight and dust, perfectly preserved in its blackbody form by the achromatic conformal transport of the temporal field. The universe becomes completely opaque at high redshift because diverging temporal transport stretches the apparent optical depth to infinity, creating an observable boundary without a physical plasma wall. The dominant dynamical cosmological observables arise exclusively in the late universe: distance probes traversing unsuppressed voids accumulate open-path temporal shear, generating the illusion of dark energy, while growth probes in dense virialized clusters are screened.
