...
\begin{equation} \label{eq:tep_bbnchrony_1}
...
\begin{equation} \label{eq:tep_bbnchrony_2}
...
\begin{equation} \label{eq:tep_bbnchrony_3}
...
\begin{equation} \label{eq:tep_bbnchrony_4}
M_{\rm app}^{\rm GR} = \frac{4\pi^2 a_{\rm GR}^3}{G P_{\rm GR}^2}
\end{equation}
...
\begin{equation} \label{eq:tep_bbnchrony_5}
...
\begin{equation} \label{eq:tep_bbnchrony_6}
...
\begin{equation} \label{eq:tep_bbnchrony_7}
\begin{aligned}
...
\begin{equation} \label{eq:tep_bbnchrony_8}
\begin{aligned}
&\text{received angles, phases and frequencies} \\
